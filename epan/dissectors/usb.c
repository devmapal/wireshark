...
static const value_string usb_products_vals[] = {
    ...
    { 0x056a00c0, "DTF-521" },
    { 0x056a00c4, "DTF-720" },
    { 0x056a00c5, "DTZ-20WSX [Cintiq 20WSX]" },
    { 0x056a00c6, "DTZ-12WX [Cintiq 12WX]" },
    { 0x056a00c7, "DTU-1931" },
    ...
    { 0x09306544, "TransMemory-Mini / Kingston DataTraveler 2.0 Stick (2GB)" },
    ...
    { 0x10581230, "My Book (WDBFJK0030HBK)" },
